package com.ohgiraffers.thymeleaf.chap02.handlermethod;
...
@SessionAttributes("id") // 세션의 정보를 id로 받아둘게
public class FirstController {
    ...
    /* 4-2 @SessionAttributes를 이용하여 sesison에 값 담기
    *  클래스 레벨에 @SessionAttributes 어노테이션을 이용해서 세션에 값을 담을 key를 설정하여
    *  model 영역에 해당 key로 값이 추가되는 경우 session에 자동으로 등록한다*/
    ...
    // SessionAttributes로 등록된 값은 session의 상태를 관리하는 sessionStatus의 setComplate() 메서드를 호출해야 사용이 만료된다
    @GetMapping("logout2")
